...
const steps = [
  ...
  },
  {
    icon: UserCheck,
    step: "02",
    title: "Sit the Entrance Examination",
  ...
  },
  {
    icon: GraduationCap,
    step: "04",
    title: "Welcome to St. Charles' College",
...
const faqs = [
  {
    ...
    a: "Admissions for each academic session typically open between November and February. Check the school portal or contact the admissions office for the exact date for the current cycle.",
  },
  {
    q: "Is St. Charles' College a boarding school?",
    a: "Yes, St. Charles' College is primarily a boys' boarding secondary school, offering full boarding facilities with structured supervision, meals, and dormitory accommodation.",
  },
  {
    q: "What is the school's religion?",
    a: "St. Charles' College is a Catholic institution under the Onitsha Archdiocese. Students of all faiths are welcome, and Christian Religious Studies is part of the curriculum.",
  },
  {
    q: "What is the medium of instruction?",
    a: "All subjects are taught in English, the official language of instruction. French, Igbo, and Mandarin Chinese are offered as additional language subjects.",
  },
  {
    q: "How competitive is the entrance exam?",
    a: "The entrance examination is competitive. We recommend students prepare thoroughly in Mathematics, English Language, and General Knowledge. Preparatory materials may be obtained from the school office.",
  },
  {
    q: "Can I check my result online?",
    a: "Yes. Students can check their academic results on the official student portal at scc.istudentng.com using their login credentials.",
  },
]
        ...
        <div className="relative z-10 container mx-auto px-4">
          ...
          >
            ...
            <p className="mt-6 max-w-2xl text-lg leading-relaxed text-primary-foreground/85">
              Every great Charlean started here — with a single application.
              Join one of Nigeria's most prestigious secondary schools.
            </p>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="mx-auto mt-4 max-w-xl text-muted-foreground">
              Our admission process is straightforward, transparent, and
              merit-based. Four clear steps stand between you and becoming a
              Charlean.
            </p>
          </motion.div>
          ...
          <div className="grid gap-8 md:grid-cols-2">
            {steps.map((s, i) => (
              <motion.div
                ...
                className="group relative overflow-hidden rounded-3xl border border-border bg-card p-10 transition-all duration-300 hover:-translate-y-1 hover:border-primary/25 hover:shadow-elevated"
              >
                <div className="absolute top-4 right-6 font-display text-8xl leading-none font-bold text-border/30 italic">
                  {s.step}
                </div>
                <div
                  className={`mb-6 flex h-16 w-16 items-center justify-center rounded-2xl ${s.color} transition-all duration-300 group-hover:scale-110`}
                >
        ...
        <div className="container mx-auto px-4">
          <div className="grid items-center gap-16 lg:grid-cols-2">
            <motion.div
              ...
              animate={reqInView ? { opacity: 1, x: 0 } : {}}
            ...
            >
              ...
              <h2 className="mb-5 font-display text-4xl font-bold text-foreground italic md:text-5xl">
                What You{" "}
                <span className="text-gradient-brand font-heading font-semibold not-italic">
                  Need
                </span>
              ...
              <p className="mb-8 leading-relaxed text-muted-foreground">
                To apply for admission into St. Charles' College, Onitsha,
                candidates must meet the following requirements and provide all
              ...
              <div className="space-y-3">
                {requirements.map((r, i) => (
                  <motion.div
                    ...
                    className="group flex items-center gap-3 rounded-xl border border-border bg-card p-4 transition-all duration-300 hover:-translate-y-0.5 hover:border-primary/25 hover:shadow-card"
                  >
                    <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg transition-transform bg-gradient-green group-hover:scale-110">
                      <CheckCircle
                        size={15}
            ...
            >
              <div className="relative h-[460px] overflow-hidden rounded-3xl shadow-elevated">
                ...
                <div className="absolute right-6 bottom-6 left-6">
                  <div className="bg-gradient-dark/90 rounded-2xl p-5 glass-dark">
                    ...
                    <Link
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="mt-3 flex items-center gap-1.5 text-sm font-semibold text-primary-foreground transition-colors hover:text-primary-foreground/80"
                    >
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mx-auto max-w-3xl space-y-4">
            {faqs.map((f, i) => (
              <motion.div
                ...
                className="group rounded-2xl border border-border bg-card p-7 transition-all duration-300 hover:-translate-y-0.5 hover:border-primary/25 hover:shadow-elevated"
              >
                <div className="mb-3 font-heading font-semibold text-foreground transition-colors group-hover:text-primary">
                  {f.q}
                </div>
                <p className="text-sm leading-relaxed text-muted-foreground">
                  {f.a}
          ...
          <div className="mt-12 text-center">
            <p className="mb-4 text-muted-foreground">
              Still have questions? Contact the admissions office directly.
            </p>
            <Link
              href="/contact"
